...
// Persistent attribution pill (bottom-left): the project is open source and runs
// on Zerops. #ui-root is pointer-events:none; `#ui-root > *` re-enables it, so the
// pill (a direct child via the App tree) and its links stay clickable.
//
